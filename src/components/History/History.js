...
let counter = 0;
function createData(movement, weight) {
  counter += 1;
  return { id: counter, movement, weight };
}
...
const rows = [
  { id: 'movement', numeric: false, disablePadding: true, label: 'Movimiento' },
  { id: 'weight', numeric: true, disablePadding: false, label: 'Peso (Kg.)' },
];
